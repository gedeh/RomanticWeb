...
{
    /// <summary>Implement to allow adding custom mapping repositories to <see cref="IEntityContextFactory"/>.</summary>
    public abstract class MappingFrom
    {
        private readonly MappingBuilder _mappingBuilder;

        /// <summary>Initializes a new instance of the <see cref="MappingFrom"/> class.</summary>
        ...
        protected MappingBuilder MappingBuilder { get { return _mappingBuilder; } }

        /// <summary>Registers a mapping repository, which will look for mappings in the given <see cref="Assembly"/>.</summary>
