...
namespace RomanticWeb.Mapping.Fluent
{
    ...
    public sealed class DictionaryMap : PropertyMapBase, IDictionaryMap
    {
        ...
        internal DictionaryMap(PropertyInfo propertyInfo) : base(propertyInfo)
        {
            _keyMap = new KeyMap();
        ...
        /// <inheritdoc/>
        public ITermPart<IDictionaryMap> Term { get { return new TermPart<DictionaryMap>(this); } }

        /// <inheritdoc />
        public ITermPart<IDictionaryMap> KeyPredicate { get { return new DictionaryPart(this, _keyMap); } }

        /// <inheritdoc />
        public ITermPart<IDictionaryMap> ValuePredicate { get { return new DictionaryPart(this, _valueMap); } }
