...
namespace RomanticWeb.Converters
{
    ...
    /// <summary>Result of matching literals for conversion by <see cref="ILiteralNodeConverter"/></summary>
...
#pragma warning disable 1591
        public int CompareTo(LiteralConversionMatch other)
        {
            ...
            return (DatatypeMatches != other.DatatypeMatches ? DatatypeMatches.CompareTo(other.DatatypeMatches) : 0);
        }
