...
namespace RomanticWeb
{
    ...
    public interface IEntityStore : IDisposable
    {
        ...
        IEnumerable<IEntityQuad> Quads { get; }

        /// <summary>Gets all objects for predicate for a given entity.</summary>
        IEnumerable<INode> GetObjectsForPredicate(EntityId entityId, Uri predicate, Uri graph);
        ...
        IEnumerable<IEntityQuad> GetEntityQuads(EntityId entityId);

        /// <summary>Adds a triple to the store.</summary>
        void AssertEntity(EntityId entityId, IEnumerable<IEntityQuad> quads);
        ...
        void ReplacePredicateValues(EntityId id, INode propertyUri, Func<IEnumerable<INode>> newValues, Uri graphUri, CultureInfo language);       
