...
namespace RomanticWeb.Entities.ResultPostprocessing
{
    ...
    public interface IResultTransformer
    {
        ...
        object FromNodes(IEntityProxy proxy, IPropertyMapping property, IEntityContext context, IEnumerable<INode> nodes);
        ...
        IEnumerable<INode> ToNodes(object value, IEntityProxy proxy, IPropertyMapping property, IEntityContext context);
    }
}